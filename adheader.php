        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="doctorprofile.php"><i class="zmdi zmdi-calendar-check"></i><span>Profile</span>
                        </a>
                    </li>

                    <li>
                        <a href="doctorchangepassword.php"><i class="zmdi zmdi-calendar-check"></i><span>Change password</span>
                        </a>
                    </li>

                    <li>
                        <a href="viewappointmentpending.php"><i class="zmdi zmdi-calendar-check"></i><span>View Appointments</span>
                        </a>
                    </li>

                    <!-- <li>
                        <a href="viewappointmentapproved.php"><i class="zmdi zmdi-calendar-check"></i><span>View Approved appointments</span>
                        </a>
                    </li> -->


                    <li>
                        <a href="doctortimings.php"><i class="zmdi zmdi-calendar-check"></i><span>Add Visitng Hours</span>
                        </a>
                    </li>


                    <li>
                        <a href="viewdoctortimings.php"><i class="zmdi zmdi-calendar-check"></i><span>View Visiting Hours</span>
                        </a>
                    </li>
                    ...
                    <!-- <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-account-add"></i><span>Visiting Hours</span> </a>
                        <ul class="ml-menu">
                            
                            <li><a href="doctortimings.php">Add </a></li>
                            <li><a href="viewdoctortimings.php">View</a></li>
                        </ul>
                    </li> -->
