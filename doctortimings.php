...
<div class="container-fluid">
	<div class="block-header">
            <h2 class="text-center">Add new slot timings</h2>
    ...
    <table class="table table-hover">
      <tbody>
        ...
        <tr>
          ...
          <td><input class="form-control"  type="time" name="ftime" id="ftime" value="<?php 
		//   echo $rsedit[start_time]; 
		  ?>"></td>
        </tr>
        <tr>
          <td height="34">To</td>
          <td><input  class="form-control" type="time" name="ttime" id="ttime"  value="<?php
		//    echo $rsedit[end_time]; 
		   ?>" ></td>
        </tr>
        <tr>
